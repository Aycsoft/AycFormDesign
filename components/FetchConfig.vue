  ...
  <div class="_fd-gfc">
    ...
    >
      <template #header>
        ...
        <Warning :tooltip="t('warning.fetch')" />
      </template>
      <el-container class="_fd-gfc-con" style="height: 450px">
        <el-tabs model-value="first" class="_fc-tabs" style="width: 100%">
          ...
          <el-tab-pane lazy :label="t('fetch.beforeFetch')" name="second">
            <template #label>
              {{ t('fetch.beforeFetch') }}
              <Warning :tooltip="t('warning.beforeFetch')" />
            </template>
            <FnEditor
              style="height: 415px"
              v-model="form.beforeFetch"
              name="beforeFetch"
              :args="['config', 'data']"
              ref="beforeFetch"
            />
          ...
          <el-tab-pane lazy name="third">
            <template #label>
              {{ t('fetch.parse') }}
              <Warning :tooltip="t('warning.fetchParse')" />
            </template>
            <FnEditor
              style="height: 415px"
              v-model="form.parse"
      ...
      this.form.api
        ...
        .then(() => {
          ...
          if (
            ...
            (this.$refs.beforeFetch && !this.$refs.beforeFetch.save()) ||
