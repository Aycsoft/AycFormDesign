<template>
  <div class="_fd-style-config">
    <BoxSpaceInput v-model="space" @change="onInput" style="margin-bottom: 10px" />
    <BoxSizeInput v-model="size" @change="onInput" />
    <ConfigItem :label="t('style.color')">
      <ColorInput v-model="color" @change="onInput" />
    </ConfigItem>
    <ConfigItem :label="t('style.backgroundColor')">
      <ColorInput v-model="backgroundColor" @change="onInput" />
    </ConfigItem>
    <BorderInput v-model="border" @change="onInput" />
    <RadiusInput v-model="radius" @change="onInput" />
    <FontInput v-model="font" @change="onInput" />
    <ShadowInput v-model="boxShadow" @change="onInput" />
    <PositionInput v-model="position" @change="onInput" />
    <ConfigItem :label="t('style.opacity')" class="_fd-opacity-input">
      <el-slider :show-tooltip="false" v-model="opacity" @change="onInput" />
      <span>{{ opacity }}%</span>
    </ConfigItem>
    <ConfigItem :label="t('style.scale')" class="_fd-opacity-input">
      <el-slider :min="80" :max="120" :show-tooltip="false" v-model="scale" @change="onInput" />
      <span>{{ scale }}%</span>
    </ConfigItem>
    <ConfigItem
...
const positionKey = ['position', 'top', 'left', 'bottom', 'right']
