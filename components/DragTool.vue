  ...
  <div class="_fd-drag-tool" @click.stop="active" :class="{ active: fcx.active === id }">
    ...
    <div class="_fd-drag-r" v-if="btns !== false && !hiddenMenu && permission.dragMenu !== false">
      <slot name="handle">
        ...
        <div
          class="_fd-drag-btn"
          v-if="permission.copy !== false && !only && (btns === true || btns.indexOf('copy') > -1)"
        ...
        <div
          ...
          v-if="permission.delete !== false && (btns === true || btns.indexOf('delete') > -1)"
          @click.stop="$emit('delete')"
        >
          <!-- <Icon icon="vi-ep:delete" class="fc-icon" /> -->
